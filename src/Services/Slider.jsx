...
const clientsData = [
  ...
  },
  {
    ...
    location: "Dhabi",
    testimonial:
      "Excellent & Efficient Tyre Replacement Service by team Lenya tyreservice-batteryreplace, Super Fast Service, Reached within few minutes and replaced Tyres, Recommended for Tyres, Battery Replacement and roadside breakdown solutions.",
    Image: SlierImage,
  },
  {
    name: "Efren Arroyo Jr.",
    location: "Sharjah",
    testimonial:
      "I was thoroughly impressed with their professionalism and expertise. The staff was friendly and communicative, keeping me updated on the progress of my repairs throughout the process. The quality of the work was top-notch and I would highly recommend this auto repair service to anyone in need.",
    Image: SlierImage,
  },
  {
    name: "Chahrazed Abdennour",
    location: "Dhabi",
    testimonial:
      "So happy with this company,  the service is very quick and professional, and especially Ahmed he is a true Hero and very professional! They even follow up and provide all the information needed.",
    Image: SlierImage,
  },
];
...
const TestimonialCard = ({ client, index }) => {
  ...
  return (
    <motion.div
      ...
      className="w-full  flex flex-col items-center text-center px-4 md:px-6 py-14 h-full rounded-3xl shadow-xl border border-gray-100 bg-white/95 backdrop-blur-sm relative overflow-hidden group hover:shadow-2xl transition-shadow duration-300"
    >
...
function Slider() {
  ...
  return (
    <section className="w-full h-full mt-[10rem] py-24 bg-gray-50 font-sans overflow-hidden" ref={ref}>
